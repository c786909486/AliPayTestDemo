...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id,String partner,String seller_id,String subject,String body,String price, boolean rsa2) {
		Map<String, String> keyValues = new HashMap<String, String>();
...
//		keyValues.put("seller_id",seller_id);
